...
function TiendaCard({ p, onOpen }: { p: Product; onOpen: () => void }) {
  ...
  return (
    <div className="tienda-card glass !p-0 overflow-hidden flex flex-col group" data-fx="card">
      <div className="aspect-square bg-gradient-hero relative overflow-hidden block w-full text-left">
        ...
        <button
          ...
          className="absolute inset-0 z-[5] cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary"
        />
      </div>
      <div className="p-4 sm:p-5 flex flex-col flex-1">
        <button type="button" onClick={onOpen} className="text-left focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary rounded">
        ...
        <div className="mt-3 flex items-center justify-between gap-2">
          ...
          <button
            type="button"
            onClick={() => add(p, 1)}
            aria-label={`Agregar ${p.name} a la canasta`}
